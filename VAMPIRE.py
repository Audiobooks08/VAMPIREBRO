...
TELEGRAM_BOT_TOKEN = '7436476611:AAEV0fF1fkoazBGEkOyDB2XZOU8s2USDYsc'
ALLOWED_USER_ID = 55351559510
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id != ALLOWED_USER_ID:5351559510
